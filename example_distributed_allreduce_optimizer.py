...
from tf_mpi.optimizers import DistributedAllReduceOptimizer
...
if __name__ == '__main__':
    ...
    net = SimpleCNN(learning_rate=1e-4 * worker_size, DistributedOptimizer=DistributedAllReduceOptimizer)
